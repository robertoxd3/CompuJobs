                                ...
                                <tbody>
                                    @foreach ($capacitacion as $capacitacion)
                                        <tr>
                                            ...
                                            <td>{{ $capacitacion->id_user }}</td>

                                            <td>
                                                <form action="{{ route('capacitacion.destroy', $capacitacion->id) }}"
                                                    method="POST">
                                                    <a class="btn btn-sm btn-primary "
                                                        href="{{ route('capacitacion.show', $capacitacion->id) }}"><i
                                                            class="fa fa-fw fa-eye"></i> Show</a>
                                                    <a class="btn btn-sm btn-success"
                                                        href="{{ route('capacitacion.edit', $capacitacion->id) }}"><i
